            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    ...
                    <div class="text-center mb-4">
                        <div class="position-relative d-inline-block">
                            ...
                            <form id="uploadForm" method="POST" enctype="multipart/form-data" action="{{ route('profil.uploadFoto') }}">
                                @csrf
                                <label for="fotoInput"
                                       class="btn btn-sm btn-light shadow position-absolute bottom-0 end-0 mb-1 me-1 rounded-circle"
                                       style="border: 1px solid #bb9587; cursor: pointer;">
                                    <i class="{{ $fotoProfil ? 'fas fa-edit text-secondary' : 'fas fa-plus text-secondary' }}"></i>
                                </label>
                                <input type="file" name="foto_profil" id="fotoInput" accept="image/*"
                    ...
                    <div class="mb-3 editable-wrapper d-flex justify-content-center align-items-center">
                        ...
                        <i class="fas fa-edit ms-2 edit-icon text-secondary" style="cursor: pointer;"></i>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('penyedia.dashboard') }}" class="btn btn-outline-secondary px-4 rounded-pill shadow-sm">Kembali</a>
                    </div>
